...
const connectDb = async () => {
    await mongoose.connect('mongodb+srv://Me:d8EfQ92DrjNnbPr@cluster0.femo3.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology : true}).then(
        () => {
...
const polycarsRoutes = require('./routes/polycars');

//Acces the routes 
app.use('/api/v1/', polycarsRoutes);
